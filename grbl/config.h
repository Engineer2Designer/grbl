...
// #define DEFAULTS_STORM_300W

#define DEFAULTS_STORM_755
...
#define SPINDLE_PWM_MIN_VALUE 30 // Default disabled. Uncomment to enable. Must be greater than zero. Integer (1-255).
